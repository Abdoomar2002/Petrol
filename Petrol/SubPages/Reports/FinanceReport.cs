...
namespace Petrol.SubPages.Reports
{
    public partial class FinanceReport : UserControl
    {
        ...
        public FinanceReport()
        {
            ...
            DataGridViewHelper.FixIndexColumnSorting(FinanceData);
        }
        ...
        private void SearchBtn_Click(object sender, EventArgs e)
        {
            ...
            var reports = service.GetAllWithNestedInclude(x=>x.Include(y=>y.Training).ThenInclude(t=>t.TrainingType).Include(y=>y.Training).ThenInclude(z=>z.Program).ThenInclude(u=>u.ProgramType)).Where(x=>x.Training.From.Date>=startDate.Date&&x.Training.To.Date<=endDate.Date).ToList();
